...
public final class GangPingRenderer {
    ...
    private static void onHudRender(DrawContext context,
        ...
        float fov = ((GameRendererInvoker) (Object) client.gameRenderer)
                .ancientsmod$getFov(camera, tickDelta, true);
