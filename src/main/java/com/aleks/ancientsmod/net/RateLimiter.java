...
public final class RateLimiter {
    ...
    public enum Kind {
        ...
        HOT_ZONE_PING(Protocol.RATE_HOT_ZONE_PING_PER_SEC),
        MINING_RUSH_PING_CLEAR(Protocol.RATE_MINING_RUSH_PING_CLEAR_PER_SEC),
        METEORITE_SHOWER_PING(Protocol.RATE_METEORITE_SHOWER_PING_PER_SEC),
        TEAR_PING(Protocol.RATE_TEAR_PING_PER_SEC),
        TEAR_PING_CLEAR(Protocol.RATE_TEAR_PING_CLEAR_PER_SEC),
        ...
        RIFT_BUDGET(Protocol.RATE_RIFT_BUDGET_PER_SEC),
