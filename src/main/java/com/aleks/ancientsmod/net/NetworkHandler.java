...
import com.aleks.ancientsmod.client.cellterm.CellTermClient;
...
import com.aleks.ancientsmod.client.hud.EventState;
import com.aleks.ancientsmod.client.hud.RiftBudgetState;
import com.aleks.ancientsmod.client.hud.MeteoriteState;
import com.aleks.ancientsmod.client.hud.MiningStatsState;
import com.aleks.ancientsmod.client.hud.OutpostState;
import com.aleks.ancientsmod.client.hud.PveStatsState;
...
import com.aleks.ancientsmod.net.payload.BugReportAiReplyPayload;
import com.aleks.ancientsmod.net.payload.BugReportErrorPayload;
import com.aleks.ancientsmod.net.payload.BugReportFiledPayload;
...
import com.aleks.ancientsmod.net.payload.DuelStatePayload;
import com.aleks.ancientsmod.net.payload.GangPingPayload;
import com.aleks.ancientsmod.net.payload.GangRosterPayload;
...
public final class NetworkHandler {
    ...
    public static void register() {
        ...
        AncientsMod.LOGGER.info("AncientsMod receivers registered on channel {}", Protocol.CHANNEL_V1);
    }
    ...
    public static void onPayload(byte[] raw) {
        try {
            ...
            if (raw == null || raw.length == 0 || raw.length > outerCap) {
                if (raw != null) AncientsMod.LOGGER.info("onPayload: dropped len={}", raw.length);
            ...
            if (typeId == Protocol.PKT_BUFF_SNAPSHOT) {
                AncientsMod.LOGGER.info("onPayload: type=PKT_BUFF_SNAPSHOT raw len={}", raw.length);
            }
            switch (typeId) {
                ...
                case Protocol.PKT_MINING_BLOCKS -> {
                    ...
                    com.aleks.ancientsmod.net.payload.MiningBlocksPayload p =
                ...
                case Protocol.PKT_BUFF_SNAPSHOT -> {
                    ...
                    com.aleks.ancientsmod.net.payload.BuffSnapshotPayload p =
                            com.aleks.ancientsmod.net.payload.BuffSnapshotPayload.decode(buf);
                    AncientsMod.LOGGER.info("BUFF_SNAPSHOT received: {} channels", p.channels.size());
                    com.aleks.ancientsmod.client.buffs.BuffSnapshotState.update(p);
                    // If the screen isn't open yet, open it; if it is, refresh it.
                    com.aleks.ancientsmod.client.screen.BuffBreakdownScreen.openNow(null);
                }
                ...
                case Protocol.PKT_DISABLED_TEXTURES -> {
                    com.aleks.ancientsmod.net.payload.DisabledTexturesPayload p =
                            com.aleks.ancientsmod.net.payload.DisabledTexturesPayload.decode(buf);
                    com.aleks.ancientsmod.client.DisabledTextures.update(p.keys());
                }
                default -> {
            ...
            AncientsMod.LOGGER.debug("dropped malformed packet", unexpected);
        }
    }
    ...
    public static void sendHandshake() {
        if (!ServerAllowlist.isAllowed()) {
            AncientsMod.LOGGER.info("sendHandshake: server not allowlisted, skipping");
            return;
        }
        if (!ClientPlayNetworking.canSend(RawPayload.ID)) {
            AncientsMod.LOGGER.info("sendHandshake: channel not registered server-side, skipping");
            return;
        }
        try {
            ...
            AncientsMod.LOGGER.info("sendHandshake: sent");
        } catch (Throwable t) {
            AncientsMod.LOGGER.warn("send handshake failed", t);
        }
    }
    ...
    public static void sendBoosterHudState(boolean on) {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send booster hud state failed", t);
        }
    }
    ...
    public static void sendMiningHudState(boolean on) {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send mining hud state failed", t);
        }
    }
    ...
    public static void sendRiftReady(int requestId) {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send rift ready failed", t);
        }
    }
    ...
    public static void sendGangPingRequest(double x, double y, double z, boolean isHeld) {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send gang ping failed", t);
        }
    }
    ...
    public static void sendBugReportSubmit(String token, int categoryMask, String description) {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send bugreport submit failed", t);
        }
    }
    ...
    public static void sendBugReportFollowup(String token, String message) {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send bugreport followup failed", t);
        }
    }
    ...
    public static void sendBugReportClose(String token, boolean resolved) {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send bugreport close failed", t);
        }
    }
    ...
    public static void sendSuggestIntent() {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send suggest intent failed", t);
        }
    }
    ...
    public static void sendSuggestSubmit(String token, byte category, String body) {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send suggest submit failed", t);
        }
    }
    ...
    public static void sendPvBundleRequest() {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send pv bundle req failed", t);
        }
    }
    ...
    public static void sendPvOpenRequest(int vaultNumber) {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send pv open req failed", t);
        }
    }
    ...
    public static void sendPvSeeClose() {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send pvsee close failed", t);
        }
    }
    ...
    public static void sendPvSwapRequest(int from, int to) {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send pv swap req failed", t);
        }
    }
    ...
    public static void sendPvExtract(int vaultNumber, int slotIndex, byte mode, byte target) {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send pv extract failed", t);
        }
    }
    ...
    public static void sendPvExtractItem(int refVault, int refSlot, byte mode, byte target) {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send pv extract item failed", t);
        }
    }
    ...
    public static void sendPvCursorPlaceInv(int playerInvSlot) {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send pv cursor place failed", t);
        }
    }
    ...
    public static void sendPvCursorReturn() {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send pv cursor return failed", t);
        }
    }
    ...
    public static void sendLootRequest() {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send loot request failed", t);
        }
    }
    ...
    public static void sendLootClose() {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send loot close failed", t);
        }
    }
    ...
    public static void sendCellTermExtract(int containerId, int slotIndex, byte mode, byte target) {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send cellterm extract failed", t);
        }
    }
    ...
    public static void sendCellTermExtractItem(int refContainerId, int refSlot, byte mode, byte target) {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send cellterm extract item failed", t);
        }
    }
    ...
    public static void sendCellTermDeposit(int playerInvSlot) {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send cellterm deposit failed", t);
        }
    }
    ...
    public static void sendCellTermCursorPlaceInv(int playerInvSlot) {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send cellterm cursor place failed", t);
        }
    }
    ...
    public static void sendCellTermCursorReturn() {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send cellterm cursor return failed", t);
        }
    }
    ...
    public static void sendCellTermClose() {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send cellterm close failed", t);
        }
    }
    ...
    public static void sendCellTermRefreshRequest() {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send cellterm refresh failed", t);
        }
    }
    ...
    public static void sendCellTermState(boolean on) {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send cellterm state failed", t);
        }
    }
    ...
    private static void sendString(byte typeId, String s) {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("send string packet failed", t);
        }
    }
