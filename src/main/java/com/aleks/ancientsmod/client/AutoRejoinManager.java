...
public final class AutoRejoinManager {
    ...
    public static void onJoin(ServerInfo info) {
        ...
        try {
            ...
            AncientsMod.LOGGER.warn("AutoRejoin: failed to parse address '{}': {}", info.address, t.getMessage());
            lastServer = null;
            lastAddress = null;
        }
    }
    ...
    public static void tick(MinecraftClient mc) {
        ...
        AncientsMod.LOGGER.info("AutoRejoin: attempt #{} → {}", attemptCount, info.address);
    ...
    private static void renderOverlay(Screen screen, DrawContext context, int mouseX, int mouseY, float tickDelta) {
        ...
        String text = secs > 0
                ? "AncientsMod: auto-rejoin in " + secs + "s"
                : "AncientsMod: reconnecting…";
