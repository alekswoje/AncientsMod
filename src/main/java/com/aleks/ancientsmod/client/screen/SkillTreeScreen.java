...
import com.aleks.ancientsmod.client.skilltree.SkillTreeArt;
...
public final class SkillTreeScreen extends Screen {
    ...
    private static final Identifier SPRITE_NODE_TEMPLATE =
            Identifier.of(AncientsMod.MOD_ID, "textures/gui/skilltree/node_base_template.png");
    ...
    private static final Identifier SPRITE_NOTABLE_TEMPLATE =
            Identifier.of(AncientsMod.MOD_ID, "textures/gui/skilltree/node_notable_template.png");
    /** Grayscale template for GRAND CAPS — climactic radiating-spike rim.
     *  Tinted at draw time. */
    private static final Identifier SPRITE_GRAND_TEMPLATE =
            Identifier.of(AncientsMod.MOD_ID, "textures/gui/skilltree/node_grand_template.png");
    /** Full-colour amethyst star for the single central GATE node. Not tinted. */
    private static final Identifier SPRITE_GATE =
            Identifier.of(AncientsMod.MOD_ID, "textures/gui/skilltree/node_gate.png");
    ...
    private static final Identifier SPRITE_RING =
            Identifier.of(AncientsMod.MOD_ID, "textures/gui/skilltree/node_border.png");
    ...
    private static final Identifier SPRITE_GLOW =
            Identifier.of(AncientsMod.MOD_ID, "textures/gui/skilltree/glow.png");
     ...
     *  {@link com.aleks.ancientsmod.client.skilltree.SkillTreeClient}'s
    ...
    private boolean textureExists(Identifier id) {
        ...
        try {
            ...
            exists = false;
            AncientsMod.LOGGER.warn("[VisionDiag] textureExists({}) threw: {}", id, t.toString());
        }
        ...
        AncientsMod.LOGGER.info("[VisionDiag] textureExists({}) = {}", id, exists);
        return exists;
    }
    ...
    private void drawSpriteTinted(DrawContext ctx, Identifier id, int cx, int cy, int radius, int tint) {
        ...
        try {
            ...
            if (diagSpritesThisFrame < 3) {
                AncientsMod.LOGGER.info("[VisionDiag] drawSpriteTinted id={} pos=({},{}) size={} tint=0x{}",
                        id, x, y, size, String.format("%08X", tint));
            }
            diagSpritesThisFrame++; // DIAG (TEMP)
        } catch (Throwable t) {
            textureExistsCache.put(id, false);
            AncientsMod.LOGGER.warn("[VisionDiag] drawSpriteTinted failed for {}: {}", id, t.toString());
        }
    }
    ...
    private static String formatEffect(SkillTreeOpenPayload.Node n) {
        ...
        return switch (n.effect) {
            ...
            case Protocol.SKILL_EFFECT_DUNGEON_DAMAGE_REDUCTION_PCT -> num + "% less Damage Taken";
