...
public final class GangPingInput {
    ...
    private static void onTick(MinecraftClient client) {
        ...
        while (KeyBinds.GANG_PING.wasPressed()) {
            AncientsMod.LOGGER.info("Gang ping: wasPressed edge");
        }
        ...
        if (down && !wasDown) {
            AncientsMod.LOGGER.info("Gang ping: press edge detected");
            pressedAtMs = now;
            previewActive = false;
        }
        ...
        if (!down && wasDown) {
            ...
            if (point != null) {
                AncientsMod.LOGGER.info("Gang ping: {} ({}s held) -> {} {} {}",
    ...
    public static Vec3d computeLiveTarget(MinecraftClient client, float tickDelta) {
        ...
        try {
            ...
            AncientsMod.LOGGER.debug("ping raycast failed", t);
            return end;
        }
    }
