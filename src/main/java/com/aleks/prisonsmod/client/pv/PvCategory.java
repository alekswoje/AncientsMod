...
public enum PvCategory {
    ...
    ENCHANT_TOOLS("enchant_tools", "Enchant Tools", "Scrolls, slot expanders, rerolls, erasers, nametags", Items.ENCHANTED_BOOK),
    ...
    TRINKETS("trinkets", "Trinkets", "Lamia's Veil, Echidna's Strand, Fortune's Dice, flares, mannequins", Items.AMETHYST_SHARD),
    ...
    CLUE_CASKETS("clue_caskets", "Clue Items", "Clue scrolls, caskets, and rerolls", Items.WRITABLE_BOOK),
    MINING_MATERIALS("mining_materials", "Mining Materials", "Condensed ore, bot items, bot fuel, forge fuel", Items.RAW_IRON),
