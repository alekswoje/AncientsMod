package com.aleks.prisonsmod.client.cellterm;

import com.aleks.prisonsmod.PrisonsMod;
import com.aleks.prisonsmod.client.FeatureToggles;
import com.aleks.prisonsmod.client.screen.CellTerminalScreen;
 ...
 *
 * <p>Unlike {@link com.aleks.prisonsmod.client.pv.PvClient} there is no
...
public final class CellTermClient {
    ...
    public static void onBundleChunk(int version, int index, int count, byte[] chunk) {
        ...
        try {
            ...
            PrisonsMod.LOGGER.debug("[CellTerm] chunked bundle decode failed", t);
        }
    }
